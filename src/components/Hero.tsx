    ...
    <section id="hero" className="relative min-h-screen flex items-center pt-20">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="text-xl text-white/80 mb-12 animate-fade-in" style={{ animationDelay: "0.4s" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="text-lg px-8 py-6 bg-white/10 text-white border-white/60 hover:bg-white hover:text-primary transition-all"
            >
              <a href="#servicos">
                Nossos serviços
